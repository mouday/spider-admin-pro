...
SCHEDULE_HISTORY_DATABASE_URL = config.get(
    "SCHEDULE_HISTORY_DATABASE_URL", default_config.SCHEDULE_HISTORY_DATABASE_URL
)
...
COMPRESS_STATIC = config.get("COMPRESS_STATIC", default_config.COMPRESS_STATIC)
